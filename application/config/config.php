...
// email and password for sending email
$config['email'] = 'baggaksonz.sanchezmira@gmail.com';
// This is a special password generated by Google for this application. It is not the same as the password for the email account.
// To generate a new password, go to https://myaccount.google.com/apppasswords. Type a name for your apppassword, then click "Generate". Copy the password and paste it here (remove the spaces).
$config['password'] = 'kitjddqugjmavnwz'; 