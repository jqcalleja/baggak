                    ...
                    <ul class="list-unstyled ps-0">
                        ...
                        <li class="mb-1">
                            ...
                            <div class="collapse ms-4" id="account-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 fs-6">
                                    <li><a href="<?= base_url('Staff/adduser') ?>" class="link-dark d-inline-flex text-decoration-none rounded">New User Account</a></li>
                                    <li><a href="<?= base_url('Staff/users') ?>" class="link-dark d-inline-flex text-decoration-none rounded">View Users List</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="border-top my-3"></li>
                        <li class="mb-1">
                            ...
                            <div class="collapse ms-4" id="system-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 fs-6">
                                    <li><a href="<?= base_url('Staff/amenities') ?>" class="link-dark d-inline-flex text-decoration-none rounded">Amenities</a></li>
                                    <li><a href="<?= base_url('Staff/foods') ?>" class="link-dark d-inline-flex text-decoration-none rounded">Foods</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="border-top my-3"></li>
