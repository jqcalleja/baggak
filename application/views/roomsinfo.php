                ...
                ?>
                        <div class="col-md-3 mb-3 mx-auto">
                            <div class="card text-white bg-secondary">
                                <a href="<?= base_url('Index/viewimage/rooms/') . $room['image']; ?>" target="_blank"><img src="<?= base_url('assets/images/rooms/thumbs/').$room['image'];?>" class="card-img-top" alt="<?= $room['name']?>"></a>
