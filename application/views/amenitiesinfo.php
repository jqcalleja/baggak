        ...
        <div class="col col-md-10 mx-auto">
            <div class="row mb-3">
                <div class="text-center">
                    <h1 class="display-6 fw-bold">Amenities</h1>
                </div>
            </div>
                ...
                ?>
                        <div class="col-md-3 mb-3 mx-auto">
                            <div class="card text-white bg-secondary">
                                <a href="<?= base_url('Index/viewimage/amenities/') . $amenity['image']; ?>" target="_blank"><img src="<?= base_url('assets/images/amenities/thumbs/').$amenity['image'];?>" class="card-img-top" alt="<?= $amenity['name']?>"></a>
