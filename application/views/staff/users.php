...
<?php endif; ?>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= base_url('Staff/user/' . $user['staffid']); ?>" class="btn btn-info"><i class="bi bi-eye"></i></a>
                                                    </a>
                                                    <?php if ($this->session->userdata('role') == 1) : ?>
                                                        <a href="<?= base_url('Staff/edituser/' . $user['staffid']); ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i>
                                                        </a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
