            <div class="col-md bg-light overflow-y-auto mx-2 vh-100">
                <div class="row justify-content-center">
                    <div class="col-md-9 m-5 px-5 py-5 bg-light border rounded-5 shadow">
                        ...
                        <?php endif; ?>
                        <form action="<?= base_url('Staff/update_profile'); ?>" method="post" novalidate>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-3">
                                    <a href="<?= base_url('Staff/myprofile'); ?>" class="btn btn-lg btn-danger w-100"><i class="bi bi-x-square me-2"></i>Cancel</a>
                                </div>
                            </div>
